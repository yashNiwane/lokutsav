...
async function main() {
  ...
  const comp = await prisma.competition.upsert({
    ...
    create: {
      ...
      descriptionMr: 'महाराष्ट्रातील सर्व ३६ जिल्ह्यांसाठी भव्य राज्यस्तरीय ऑनलाइन गणेश सजावट स्पर्धा.',
      year: 2026,
      entryFee: 199,
      prizePoolText: '₹1,50,000+ in Cash & Gold Trophies',
      prizePoolTextMr: '₹१,५०,०००+ रोख व मानाच्या सुवर्ण ट्रॉफीज',
  ...
  const sponsors = [
    {
      ...
      descriptionMr: 'महाराष्ट्राचे लाडके मिष्ठान्न ब्रँड, ८ दशकांपासून परंपरेची गोडी जपणारे चितळे बंधू.',
      sortOrder: 1,
    },
    {
      id: 'sp-2',
      ...
      descriptionMr: 'शुद्धता, विश्वास आणि १९०+ वर्षांचा सुवर्ण वारसा जपणारे पी एन जी ज्वेलर्स.',
      sortOrder: 2,
    },
  ];
