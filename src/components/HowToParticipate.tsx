...
export default function HowToParticipate() {
  ...
  const steps = [
    ...
    {
      num: '03',
      titleMr: '₹199 शुल्क भरा व तिकीट मिळवा',
      titleEn: 'Pay ₹199 & Get Entry Ticket',
      descMr: 'UPI (GPay/PhonePe/Paytm) किंवा कार्डद्वारे ₹199 भरणा करून अधिकृत प्रवेश तिकीट तात्काळ डाऊनलोड करा.',
      descEn: 'Pay ₹199 via UPI Intent or Card and instantly download your verified digital entry pass.',
