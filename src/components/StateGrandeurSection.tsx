      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className="bg-[#FAF7F2] p-6 rounded-2xl border border-[#E5D7C0] space-y-3">
            ...
            <p className="text-xs text-stone-600 leading-relaxed">
              प्रथम क्रमांकास मानाची सुवर्ण ट्रॉफी व ₹51,000 रोख, तर अव्वल 10 विजेत्यांना रोख रकमा व प्रायोजक हॅम्पर्स.
            </p>
          </div>
        ...
        <div className="bg-[#FAF7F2] rounded-3xl p-8 border border-[#E5D7C0]">
          ...
          <div className="mt-8 text-center">
            ...
            >
              <span>आपल्या विभागाचे प्रतिनिधित्व करा — नोंदणी करा (₹199)</span>
            </Link>
          </div>
        </div>
      </div>
